        ...
        <form action="{{ route('kapal.store') }}" class="w-full mb-5" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" id="namaKapal"
                    class="input input-bordered @error('nama_kapal') input-error @enderror bg-slate-800 w-full focus:text-slate-400"
            ...
            <div class="mb-4">
                ...
                <input type="text" id="keagenan"
                    class="input input-bordered @error('keagenan') input-error @enderror bg-slate-800 w-full focus:text-slate-400"
                    ...
                    <div class="flex gap-2 mx-2">
                        <div class="w-full">
                            ...
                            <input type="number" id="loa"
                                class="input input-bordered @error('loa') input-error @enderror bg-slate-800 w-full focus:text-slate-400"
                                name="loa" required />
                        </div>
                        @error('loa')
                            <div class="text-error flex mb-1">
                        ...
                        <div class="w-full mb-2">
                            ...
                            <input type="number" id="gt"
                                class="input input-bordered @error('gt') input-error @enderror bg-slate-800 w-full focus:text-slate-400"
                                name="gt" required />
                        </div>
                        @error('gt')
                            <div class="text-error flex mb-1">
            ...
            <div class="mb-4">
                ...
                <select class="select select-bordered @error('pemilik') select-error @enderror w-full bg-slate-800"
            ...
            <div class="mb-4">
                ...
                <input type="text" id="bendera"
                    class="input input-bordered @error('bendera') inpur-error @enderror bg-slate-800 w-full focus:text-slate-400"
            ...
            <div class="mb-4">
                ...
                <input type="date" id="tanggal"
                    class="input input-bordered @error('tanggal') inpur-error @enderror bg-slate-800 w-full focus:text-slate-400"
